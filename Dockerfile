...
# Put the nusuk CLI and local node_modules/.bin on PATH. Also create a `nusuk`
# symlink so the command works without the .js extension (npm ci doesn't create
# bin links for the package itself).
