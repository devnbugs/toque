...
const CMD_CATALOG = {
  ...
  groups:           { args: ["--limit", "--offset", "--raw-json", "--ea-code", "--state", "--group-id"], description: "List groups (list), show details (detail), or set default group (set)" },
  ...
  sync:            { args: ["--endpoint", "--api-token", "--signing-secret", "--entity", "--system-user"], description: "Sync autha-worker credentials to local config + .env" },
